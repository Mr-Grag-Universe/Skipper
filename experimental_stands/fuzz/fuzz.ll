; ModuleID = 'experimental_stands/fuzz/fuzz.cpp'
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef i64 @_Z16my_asm_factoriali(i32 noundef %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i64, align 8
  store i32 %0, ptr %2, align 4
  %4 = load i32, ptr %2, align 4
  %5 = call i64 asm "loop_start:mul %rdi;dec %rdi;jg loop_start;end:mov %rax, $0;", "=r,r,~{rax},~{rdi},~{dirflag},~{fpsr},~{flags}"(i32 %4) #7, !srcloc !9
