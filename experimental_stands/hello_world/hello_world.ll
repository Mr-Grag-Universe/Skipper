; ModuleID = 'experimental_stands/hello_world/hello_world.cpp'
source_filename = "experimental_stands/hello_world/hello_world.cpp"
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_hello_world.cpp() #0 section ".text.startup" {
